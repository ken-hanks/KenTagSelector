#
#  Be sure to run `pod spec lint KenTagSelector.podspec' to ensure this is a
...
一个类似网易栏目选择器的标签选择界面，可单选栏目或将栏目加入选择列表。已选栏目支持拖拽排序, 已适配暗黑模式。
  ...
  spec.author             = { "ken-hanks" => "han.kang@qq.com" }
  # Or just: spec.author    = "ken-hanks"
  # spec.authors            = { "ken-hanks" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/ken-hanks"
  ...
  spec.source       = { :git => "https://github.com/ken-hanks/KenTagSelector.git", :tag => "#{spec.version}" }
